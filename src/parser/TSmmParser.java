	...
	public final Variable_definitionContext variable_definition() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				match(T__1);
				setState(63);
				((Variable_definitionContext)_localctx).expression = expression(0);
				setState(64);
				match(T__2);

				            _localctx.ast.add(new LetStatement(
				                ...
				                new Variable(((Variable_definitionContext)_localctx).ID.getLine(), ((Variable_definitionContext)_localctx).ID.getCharPositionInLine()+1, (((Variable_definitionContext)_localctx).ID!=null?((Variable_definitionContext)_localctx).ID.getText():null)),
				                ((Variable_definitionContext)_localctx).expression.ast
				                )
				            );
