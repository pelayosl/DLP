...
public class TSmmParser extends Parser {
	...
	public final Function_definitionContext function_definition() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 131941420871744L) != 0)) {
				{
				{
				setState(102);
	...
	public final ExpressionListContext expressionList() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 131941420499008L) != 0)) {
				{
				setState(178);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 5:
						...
						match(T__1);
						setState(316);
						((ExpressionContext)_localctx).ex3 = ((ExpressionContext)_localctx).expression = expression(2);
						                               ...
						                               ((ExpressionContext)_localctx).ast =  new TernaryOperator(
						                                   ...
						                                   ((ExpressionContext)_localctx).ex1.ast,
						                                   ((ExpressionContext)_localctx).ex2.ast,
						                                   ((ExpressionContext)_localctx).ex3.ast
						                               );
